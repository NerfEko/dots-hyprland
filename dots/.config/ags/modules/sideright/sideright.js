...
import ModuleVpnConnections from "./centermodules/vpnconnections.js";
...
const QUICK_TOGGLES = {
    ...
    'protonvpn': await ModuleProtonVPN(),
}

// VPN tab index — used by the toggle button's right-click to jump to the VPN panel
const VPN_TAB_NAME = 'ProtonVPN';
...
const centerWidgets = [
    ...
    {
        name: getString('ProtonVPN'),
        materialIcon: 'shield',
        contentWidget: ModuleVpnConnections,
    },
    {
...
// Register global so the ProtonVPN toggle button can switch to the VPN tab on right-click
globalThis.__sidebarShowVpn = () => {
    sidebarOptionsStack.focusName(getString('ProtonVPN'));
};
