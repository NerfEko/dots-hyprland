...
- GPU Mode - uses [SuperGfxCtl](https://wiki.archlinux.org/title/Supergfxctl) to change GPU mode on gaming laptops
  - [GpuMode.qml](https://github.com/NerfEko/dots-hyprland/blob/main/dots/.config/quickshell/ii/services/GpuMode.qml) - Main service
  - [GpuModeToggle.qml](https://github.com/NerfEko/dots-hyprland/blob/main/dots/.config/quickshell/ii/modules/common/models/quickToggles/GpuModeToggle.qml) - Toggle button
  - [GpuModeDialog.qml](https://github.com/NerfEko/dots-hyprland/blob/main/dots/.config/quickshell/ii/modules/ii/sidebarRight/gpuMode/GpuModeDialog.qml) - Dialog
- ProtonVPN - added menu for quick connect and choosing between recent or fastest servers.
  - [ProtonVpnToggle.qml](https://github.com/NerfEko/dots-hyprland/blob/main/dots/.config/quickshell/ii/modules/common/models/quickToggles/ProtonVpnToggle.qml) - Toggle button
  - [VpnDialog.qml](https://github.com/NerfEko/dots-hyprland/blob/main/dots/.config/quickshell/ii/modules/ii/sidebarRight/vpnConnections/VpnDialog.qml) - VPN dialog
