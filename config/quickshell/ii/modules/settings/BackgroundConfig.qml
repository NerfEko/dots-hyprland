...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            text: Translation.tr("Show only when music is playing")
            checked: Config.options.background.widgets.music.showOnlyWhenPlaying
            onCheckedChanged: {
                Config.options.background.widgets.music.showOnlyWhenPlaying = checked;
            }
        }
        ...
        ConfigRow {
            ...
            ConfigSlider {
                ...
                value: 2
                onValueChanged: {
                    var sizes = [180, 220, 280, 320, 380];
                    var idx = Math.round(value);
                    var newWidth = sizes[idx];
                    Config.options.background.widgets.music.width = newWidth;
                    Config.options.background.widgets.music.height = Math.round(newWidth * 1.45);
                }
            }
        }
        ...
        Item {
            ...
            StyledText {
                ...
                text: `${Config.options.background.widgets.music.width} x ${Config.options.background.widgets.music.height}`
            }
        }
}
